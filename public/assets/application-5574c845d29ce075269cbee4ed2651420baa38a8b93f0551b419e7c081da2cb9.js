...
$(function() {
  var unit_lookup = {};
    ...
    if ( !("Strength" in unit_lookup) ) {
      unit_lookup["Strength"] = [];
    }
    unit_lookup["Strength"].push({"name": "lbs", "id" : "1"});
  
    if ( !("Strength" in unit_lookup) ) {
      unit_lookup["Strength"] = [];
    }
    unit_lookup["Strength"].push({"name": "kgs", "id" : "2"});
  
    if ( !("Cardio" in unit_lookup) ) {
      unit_lookup["Cardio"] = [];
    }
    unit_lookup["Cardio"].push({"name": "meters", "id" : "3"});
  
    if ( !("Cardio" in unit_lookup) ) {
      unit_lookup["Cardio"] = [];
    }
    unit_lookup["Cardio"].push({"name": "miles", "id" : "4"});
  
    if ( !("Cardio" in unit_lookup) ) {
      unit_lookup["Cardio"] = [];
    }
    unit_lookup["Cardio"].push({"name": "minutes", "id" : "5"});
  
    if ( !("Cardio" in unit_lookup) ) {
      unit_lookup["Cardio"] = [];
    }
    unit_lookup["Cardio"].push({"name": "hours", "id" : "6"});
  
    if ( !("Cardio" in unit_lookup) ) {
      unit_lookup["Cardio"] = [];
    }
    unit_lookup["Cardio"].push({"name": "seconds", "id" : "7"});
